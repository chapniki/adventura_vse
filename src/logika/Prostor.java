...
public class Prostor {
 ...
 private Map<String, Vec> seznamVeci;   // seznam věcí v prostoru
     ...
     * @param postava postava která se nachází v prostoru
     */

    public Prostor(String nazev, String popis, Postava postava) {
        this.nazev = nazev;
        this.popis = popis;
        vychody = new HashSet<>();
    ...
    /**
     *  Metoda vrací postavu v prostoru
     */
 ...
 /**
     * Vkladá věc do prostoru
     *
     *@param vec vec kterou vkládáme do prostoru
     */
   public void vlozVec (Vec vec) {
     ...
     *@return  nazvy vecí které se nacházejí v prostoru
     */
    public String nazvyVeci () {
        StringBuilder nazvy = new StringBuilder("věci: ");
    ...
    public Vec vyberVec (String jmeno) {
        Vec nalezenaVec = seznamVeci.get(jmeno);
        seznamVeci.remove(jmeno);
        return nalezenaVec;
    }
    /**
     *  Metoda vrací true jestli je hledaná věc přenositelná
     */
    public boolean vecJeMozneVzit (String nazev){
        return seznamVeci.containsKey(nazev) && seznamVeci.get(nazev).isPickable();
    }
